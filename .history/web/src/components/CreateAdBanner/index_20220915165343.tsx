import * as Dialog from "@radix-ui/react-popover" 
    ...
    return (
        ...
        <div className="bg-[#2A2634] px-8 py-6 flex justify-between items-center">
            ...
            <span className="text-zinc-400 block text-sm mt-1">Publique um anúncio para encontrar novos players!</span>
                ...
                <Dialog.Trigger className="px-3 py-4 bg-violet-500 hover:bg-violet-600 text-white rounded flex items-center gap-3">
