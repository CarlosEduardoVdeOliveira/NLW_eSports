            ...
            <div className="w-[480px] h-[651px] bg-[#2A2634] rounded px-10 py-8">
                ...
                <form action="" className="mt-4">
                   ...
                   <div className="flex flex-rows items-center justify-center gap-6">
                     <label htmlFor="" className="py-3 text-white font-semibold block text-sm">
                        Quando costuma jogar?
                        <div id="s" className="bg-zinc-900 w-[40px] mt-3 items-center flex justifyContent-center placeholder:text-zinc-500 pl-3 h-[40px] rounded">S</div>
                        <div id="s" className="bg-zinc-900 w-[40px] mt-3 items-center flex justifyContent-center placeholder:text-zinc-500 pl-3 h-[40px] rounded">T</div>
                        <div id="s" className="bg-zinc-900 w-[40px] mt-3 items-center flex justifyContent-center placeholder:text-zinc-500 pl-3 h-[40px] rounded">Q</div>
                        <div id="s" className="bg-zinc-900 w-[40px] mt-3 items-center flex justifyContent-center placeholder:text-zinc-500 pl-3 h-[40px] rounded">Q</div>
                        <div id="s" className="bg-zinc-900 w-[40px] mt-3 items-center flex justifyContent-center placeholder:text-zinc-500 pl-3 h-[40px] rounded">S</div>
                    </label>
