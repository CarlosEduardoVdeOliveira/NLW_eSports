      ...
      <div className="w-[480px] h-[651px] bg-[#2A2634] rounded px-10 py-8">
        ...
        <form action="" className="mt-4">
          ...
          <div className="flex flex-rows items-center justifyContent-center gap-6">
            ...
            <strong className=" py-2 text-white font-semibold text-sm">
                Quando costuma jogar?
            </strong>
          <div className="flex flex-rows items-center justify-center">
            <div className="flex  text-white font-semibold text-sm gap-2">
              <div className="bg-zinc-900 w-[40px] mt-3 items-center flex justifyContent-center placeholder:text-zinc-500 pl-3 h-[40px] rounded select:bg-violet-500">
                S
              </div>
              <div className="bg-zinc-900 w-[40px] mt-3 items-center flex justifyContent-center placeholder:text-zinc-500 pl-3 h-[40px] rounded">
                T
              </div>
              <div className="bg-zinc-900 w-[40px] mt-3 items-center flex justifyContent-center placeholder:text-zinc-500 pl-3 h-[40px] rounded">
                Q
