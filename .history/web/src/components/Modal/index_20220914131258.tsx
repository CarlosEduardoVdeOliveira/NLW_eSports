        ...
        <form action="" className="mt-4">
          ...
          <div className="flex flex-rows items-center justify-center">
            <div className="flex  text-white font-semibold text-sm gap-2">
              <div className="bg-zinc-900 w-[40px] mt-3 items-center flex justifyContent-center placeholder:text-zinc-500 pl-3 h-[40px] rounded active:bg-violet-500">
                S
              </div>
              <div className="bg-zinc-900 w-[40px] mt-3 items-center flex justifyContent-center placeholder:text-zinc-500 pl-3 h-[40px] rounded active:bg-violet-500">
                T
              ...
              <div className="bg-zinc-900 w-[40px] mt-3 mr-3 items-center flex justifyContent-center placeholder:text-zinc-500 pl-3 h-[40px] rounded active:bg-violet-500">
                S
              </div>
            </div>
            
            <div className="text-white block font-semibold text-sm">
              <input
                id="initGame"
