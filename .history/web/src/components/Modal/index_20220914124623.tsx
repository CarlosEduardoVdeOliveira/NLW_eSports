                ...
                <form action="" className="mt-4">
                   ...
                   <div className="flex flex-rows items-center justify-center gap-6">
                     ...
                     <div className="py-3 flex  text-white font-semibold text-sm gap-2">
                        ...
                        <div id="t" className="bg-zinc-900 w-[40px] mt-3 items-center flex justifyContent-center placeholder:text-zinc-500 pl-3 h-[40px] rounded">T</div>
                        <div id="q" className="bg-zinc-900 w-[40px] mt-3 items-center flex justifyContent-center placeholder:text-zinc-500 pl-3 h-[40px] rounded">Q</div>
                        <div id="q" className="bg-zinc-900 w-[40px] mt-3 items-center flex justifyContent-center placeholder:text-zinc-500 pl-3 h-[40px] rounded">Q</div>
                        <div id="s" className="bg-zinc-900 w-[40px] mt-3 items-center flex justifyContent-center placeholder:text-zinc-500 pl-3 h-[40px] rounded">S</div>
                    </div>
