      ...
      <div className="w-[480px] h-[651px] bg-[#2A2634] rounded px-10 py-8">
        ...
        <form action="" className="mt-4">
          ...
          <div className="flex flex-rows items-center justify-center">
            <div className="flex  text-white font-semibold text-sm gap-2 mt-3">
            ...
            <div className="py-2 text-white block font-semibold text-sm ml-2 block">
                <strong className="text-white font-semibold text-sm">
                Qual horário do dia?
            </strong>
              <input
                id="initGame"
                className="bg-zinc-900 w-[80px] h-[40px] mt-3 placeholder:text-zinc-500 pl-3 mr-1.5 rounded"
                placeholder="De"
              />
              <input
                id="endGame"
                className="bg-zinc-900 w-[80px] h-[40px] mt-3 placeholder:text-zinc-500 pl-3 rounded"
                placeholder="Até"
              />
            </div>
          </div>
