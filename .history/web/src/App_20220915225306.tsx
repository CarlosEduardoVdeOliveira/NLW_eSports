              ...
              <form className="mt-8 flex flex-col gap-4">
                ...
                <div className="flex gap-6">
                  <div className="flex flex-col gap-2 ">
                    ...
                    <button title="Domigo">D</button>
                    <button title="Segunda-feira">S</button>
                    <button title="Terça-feira">T</button>
                    <button title="Quarta-feira">Q</button>
                    <button title="Quinta-feira">Q</button>
                    <button title="Sexta-feira">S</button>
