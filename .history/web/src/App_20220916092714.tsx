...
function App() {
  ...
  <div className="max-w-[130px] mx-auto flex flex-col items-center my-20 ">
    <img src={logo} alt="" />
            ...
            <Dialog.Title className="text-3x font-black">Publique um anúncio</Dialog.Title>
              <form className="mt-8 flex flex-col gap-4">
                ...
                <footer className="mt-4 flex justify-end gap-4">
                  <Dialog.Close
                    type="button"
                    className="bg-zinc-500 h-12 px-5 rounded-md font-semibold hover:bg-zinc-600"
                  >
                      Cancelar
                  </Dialog.Close>
                  <button
                    type="submit"
                    className="bg-violet-500 flex items-center gap-3 h-12 px-5 rounded-md font-semibold hover:bg-violet-600"
                  >
